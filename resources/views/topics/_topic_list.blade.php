      ...
      <li class="media">
        <div class="media-left">
          <a href="{{ route('users.show',[$topic->user_id]) }}">
            <img src="{{ $topic->user->avatar }}" class="media-object img-thumbnail mr-3" style="width: 52px; height: 52px;">
          </a>
        </div>
        ...
        <div class="media-body">
          ...
          <small class="media-body meta text-secondary">
           ...
           <span> · </span>
           <a href="{{ route('users.show',[$topic->user_id]) }}" title="{{ $topic->user->name }}" class="text-secondary">{{ $topic->user->name }}</a>
           <span> · </span>
